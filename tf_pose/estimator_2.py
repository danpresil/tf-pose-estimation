...
class TfPoseEstimator:
    ...
    def drawline(img,pt1,pt2,color,thickness=1,style='dotted',gap=20):
        ...
        if style=='dotted':
            for p in pts:
                cv2.circle(img,p,thickness,color,-1, lineType=8)
        else:
            s=pts[0]
            e=pts[0]
            i=0
    ...
    def draw_humans(npimg, humans, imgcopy=False):
        ...
        for human in humans:
            ...
            if 4 in human.body_parts.keys() and 7 in human.body_parts.keys():
                width_average = 700
                height_delta_average = 5
                center_average = ((centers[4][0] + centers[7][0])//2, (centers[4][1] + centers[7][1])//2)
                center_average_top_0 = (center_average[0] - width_average//2, center_average[1] - height_delta_average)
                center_average_top_1 = (center_average[0] + width_average//2, center_average[1] - height_delta_average)
                center_average_bottom_0 = (center_average[0] - width_average//2, center_average[1] + height_delta_average)
                center_average_bottom_1 = (center_average[0] + width_average//2, center_average[1] + height_delta_average)
                
                average_line_color = (0, 0, 255)
                if centers[4][1] > center_average_top_0[1] and centers[4][1] < center_average_bottom_0[1]:
                    average_line_color = (0, 255, 0)
                
                cv2.line(npimg, center_average_top_0, center_average_top_1, average_line_color, 2)
                cv2.line(npimg, center_average_bottom_0, center_average_bottom_1, average_line_color, 2)
				
                width = 250
                center_4_0 = (centers[4][0] - width//2, centers[4][1])
                center_4_1 = (centers[4][0] + width//2, centers[4][1])
                center_7_0 = (centers[7][0] - width//2, centers[7][1])
                center_7_1 = (centers[7][0] + width//2, centers[7][1])
                cv2.line(npimg, center_4_0, center_4_1, common.CocoColors[4], 2)
                cv2.line(npimg, center_7_0, center_7_1, common.CocoColors[7], 2)				
            ...
            for pair_order, pair in enumerate(common.CocoPairsRender):
                ...
                TfPoseEstimator.drawline(npimg, centers[pair[0]], centers[pair[1]], (255,255,255), 3, gap=10)
